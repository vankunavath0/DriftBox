// Import the Multer middleware configured for file uploads
...
// Configure Multer to handle a single file upload with the field name 'file'
...
const handleFileUpload = async (req, res) => {
    try {
        ...
        const newFile = new File({
            ...
            user: req.user.id // Save the user ID extracted from the JWT token
        });
